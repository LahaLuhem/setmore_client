...
// tests for CreateCustomerRequestDto
void main() {
  final CreateCustomerRequestDto? instance = /* CreateCustomerRequestDto(...) */ null;
  ...
  group(CreateCustomerRequestDto, () {
    ...
    // String workPhone
    test('to test the property `workPhone`', () async {
      // TODO
    });

    // String homePhone
    test('to test the property `homePhone`', () async {
      // TODO
    });
